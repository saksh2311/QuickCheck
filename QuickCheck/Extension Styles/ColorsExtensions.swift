...
extension UIColor{
    ...
    static let MyGreen = UIColor(netHex: 0x0EC20E)

    static let lightWhite = UIColor.init(netHex: 0xefefef)
    
    static let myGreenTint = UIColor.init(netHex: 0xb1ffaa)
    static let myRedTint = UIColor.init(netHex: 0xfc9999)
    
    static let myOrange = UIColor.init(netHex: 0xff8f00)
}
